...
#set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33} [get_ports {length_select}]
...
#set_property -dict {PACKAGE_PIN W11 IOSTANDARD LVCMOS33} [get_ports adc_CS]
#set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports adc_MOSI]
#set_property -dict {PACKAGE_PIN T5  IOSTANDARD LVCMOS33} [get_ports adc_MISO]
#set_property -dict {PACKAGE_PIN U10 IOSTANDARD LVCMOS33} [get_ports adc_SCK]
